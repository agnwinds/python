...
def analyze_pyfit3_results(filename,col,cutoff,nx,ny):
...
def plot_good(data,models,wmin,wmax):
    ...
    print('boogie',modelcolumns)
    lin=len(modelcolumns)

    print("plot_good",data,wmin,wmax)
#        print models
...
def gui():
    ...
    def process1():
        ...
        xmodels=analyze_pyfit3_results(filename,col,cutoff,nx,ny)
