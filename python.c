 ...
 */
  ...
  if (geo.ioniz_mode == 4 || geo.ioniz_mode == 5 || geo.ioniz_mode > 9)	/*NSH CLOUDY test - remove once done */
    {
      Log ("The allowed ionization modes are 0, 1, 2, 3, 6, 7, 8, 9\n");
...
/* This step shoudl be MPI_parallelised too */
	...
	free(redhelper2);
      ...
      xsignal (root, "%-20s Finished %d of %d ionization cycle \n", "OK",
	       geo.wcycle, wcycles);
      geo.wcycle++;		/*Increment ionisation cycles - seems out of order, but it doesnt matter because the test is made at the end of the loop..*/
