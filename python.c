 ...
 */
      ...
      for (j = 0; j < subcycles; j++)
	{
	  ...
	  Log
	    ("!!python: Total photon luminosity after transphot %18.12e (diff %18.12e). Radiated luminosity %18.12e, Adiabatic lum %18.12e\n",
	     zzz, zzz - zz, zze, zz_adiab);
	  Log("Total photons %d Adiabatic photons %d\n", NPHOT, nn_adiab);
