...
{
  double lum, lum_lines, cool_rr, lum_ff, cool_comp, lum_dr, cool_di, lum_adiab, heat_adiab;       //1108 NSH Added a new variable for compton cooling 1408 NSH and for DI cooling
  ...
  lum = lum_lines = cool_rr = lum_ff = cool_comp = lum_dr = cool_di = lum_adiab = heat_adiab = 0;  //1108 NSH Zero the new counter 1109 including DR counter 1408 and the DI counter
  for (n = 0; n < NDIM2; n++)
  {
