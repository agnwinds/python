 ...
 *
 * @details
 * These routines gneerate a cumulative distribution functions
 * 	and then allow one to sample that distribution function.  
 *
 ...
 *
 * 	Once the cdfs are generated one can smaple the distritution functions witt ??
 *
 ***********************************************************/
