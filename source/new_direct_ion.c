 ...
 * @brief      computes the rates for three body recombination from Dere data.
 *
 * @param [in] double  T   Temperature in K
 * @return     0 on success
 *
 * @details
 * This routine calculates the three body recombiniation rate coefficient for all
 ...
 * data.
 * The hard work is done in a seperate routine
 *
 * ### Notes ###
 * 1508 JM coded
 *
...
//OLD /******************************************************************************
//OLD 
//OLD  q_ioniz. This returns the collisional ionization co-efficient
//OLD Calculated following equation 5-79 of Mihalas or from data from
//OLD Dere 2007.
//OLD ******************************************************************************/
 ...
 * @param [in out] double  electron_temperature   ???
 * @return     ??? RETURNS ???
 *
 * @details
 * ??? DESCRIPTION ???
...
//OLD /******************************************************************************
//OLD 
//OLD  q_recomb_dere. This returns the collisional recombination co-efficient
//OLD Calculated from inverse of q_ioniz_dere.
//OLD 
//OLD This equation comes from considering TE and getting the expression
//OLD q_recomb = 2.07e-16 * gl/gu * exp(E/kT) * q_ioniz
//OLD then substituting the above expression for q_ioniz.
//OLD ******************************************************************************/
...
//OLD /******************************************************************************
//OLD 
//OLD  q_recomb. This returns the collisional recombination co-efficient
//OLD Calculated from inverse of q_ioniz.
//OLD 
//OLD JM 1301 -- Edited this to avoid need to call q_ioniz and exponential.
//OLD Should improve speed and stability
//OLD 
//OLD This equation comes from considering TE and getting the expression
//OLD q_recomb = 2.07e-16 * gl/gu * exp(E/kT) * (T_e**-3/2) * q_ioniz
//OLD then substituting the above expression for q_ioniz.
//OLD ******************************************************************************/
