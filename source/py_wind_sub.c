...
a:printf ("There are %i wind elements in this model\n", NDIM2);
  ...
  Log
    ("t_e %8.2e cool_tot %8.2e lum_lines  %8.2e lum_ff  %8.2e cool_rr     %8.2e cool_comp %8.2e cool_adiab %8.2e cool_DR %8.2e \n",
     xplasma->t_e, xplasma->lum_rad_ioniz + xplasma->cool_comp_ioniz + xplasma->cool_adiabatic_ioniz + xplasma->cool_dr_ioniz,
  ...
  Log ("The ratio of rad (total) cooling to heating is %8.2f (%8.2f) \n",
       ...
       (xplasma->lum_rad_ioniz + xplasma->cool_adiabatic_ioniz + xplasma->cool_comp_ioniz + xplasma->cool_dr_ioniz) / xplasma->heat_tot);
  Log ("Adiabatic cooling %8.2e is %8.2g of total cooling\n",
       xplasma->cool_adiabatic_ioniz,
       xplasma->cool_adiabatic_ioniz / (xplasma->lum_rad + xplasma->cool_adiabatic + xplasma->cool_comp_ioniz + xplasma->cool_dr_ioniz));
  ...
  Log ("Compton cooling   %8.2e is %8.2g of total cooling\n",
       ...
       xplasma->cool_comp_ioniz / (xplasma->lum_rad + xplasma->cool_adiabatic + xplasma->cool_comp_ioniz + xplasma->cool_dr_ioniz));
  Log ("DR cooling        %8.2e is %8.2g of total cooling\n", xplasma->cool_dr_ioniz,
       xplasma->cool_dr_ioniz / (xplasma->lum_rad + xplasma->cool_adiabatic + xplasma->cool_comp_ioniz + xplasma->cool_dr_ioniz));
...
cool_tot\tlum_rad\tcool_rr\tlum_ff\tlum_lines\tcool_adiabatic\tcool_comp\tcool_dr\t \
