...
int macro_pops_fill_rate_matrix(MacroPtr mplasma, PlasmaPtr xplasma, double xne, int index_element, double rate_matrix[2000][2000], int radiative_flag[2000][2000], int conf_to_matrix[2000]);
int macro_pops_check_for_population_inversion(int index_element, double *populations, int radiative_flag[2000][2000], int conf_to_matrix[2000]);
int macro_pops_check_densities_for_numerical_errors(PlasmaPtr xplasma, int index_element, double *populations, int conf_to_matrix[2000], int n_iterations);
void macro_pops_copy_to_xplasma(PlasmaPtr xplasma, int index_element, double *populations, int conf_to_matrix[2000]);
