...
void check_heating_cooling_rates_for_plasma_cell (int n_plasma);
/* windsave.c */
...
void communicate_macro_alpha_sp_recomb (const int n_start, const int n_stop, const int n_cells_rank);
